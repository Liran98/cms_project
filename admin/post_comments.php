      ...
      $query = "SELECT * FROM comments WHERE comment_post_id = $id";
                ...
                ?>
                 <tr>
                     ...
                     <td><a href="post_comments.php?approve=<?php echo $comment_id; ?>">approve</a>
                     <td><a href="post_comments.php?unapprove=<?php echo $comment_id; ?>">unapprove</a></td>

                     <td><a href="post_comments.php?delete=<?php echo $comment_id; ?>&id=<?php echo $id; ?>">🗑️</a></td>
